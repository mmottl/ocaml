...
#include <math.h>
int main (void) {
  /* Tests 264-266, 273 from testsuite/tests/fma/fma.ml. These tests trigger the
  ...
  z = 0x4p-1076;
  t266 = fma(x, y, z);
  x = -0x3.ffffffffffffep-712;
  y = 0x3.ffffffffffffep-276;
  z = 0x3.fffffc0000ffep-984;
  t273 = fma(x, y, z);
  return (t264 != 0x1.0989687cp-1044
       || t265 != 0x1.0988p-1060
       || t266 != 0x8p-1076
       || t273 != 0x2.fffffc0000ffep-984);
}
    ]])],
    [AC_MSG_RESULT([yes])
